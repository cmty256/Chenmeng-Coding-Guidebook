...
- [MySQL数据库索引的类型、命名规范、建立原则以及索引失效的情况_索引命名-CSDN博客](https://blog.csdn.net/u013068184/article/details/107298993)
- [mysql-笔记-命名、索引规范_联合索引命名规范-CSDN博客](https://blog.csdn.net/qq_18671415/article/details/109110252)
- [MySQL 创建与修改 索引（ALTER命令）_mysql alter index-CSDN博客](https://blog.csdn.net/Hardworking666/article/details/122247651)
