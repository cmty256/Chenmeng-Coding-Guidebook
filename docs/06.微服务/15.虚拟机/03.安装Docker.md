...
> 报错参考：[CentOS7 yum安装报错“Could not resolve host: mirrorlist.centos.org； Name or service not known“之解决办法（换源）_could not resolve host: mirrorlist.centos.org; nam-CSDN博客](https://blog.csdn.net/masound/article/details/140123479)
