...
![image](https://cdn.staticaly.com/gh/cmty256/imgs-blog@main/basics/image.7gibr1r2uhk0.webp)
...
![image](https://cdn.staticaly.com/gh/cmty256/imgs-blog@main/basics/image.26705an7w4ao.webp)

> 规模较大时

![image](https://cdn.staticaly.com/gh/cmty256/imgs-blog@main/basics/image.4wnev1pq6nc0.webp)
...
![image](https://cdn.staticaly.com/gh/cmty256/imgs-blog@main/basics/image.7fuaudhgdww0.webp)

- 总共执行次数 = 1 + 2 + 4 + 8 = 2^0 + 2^1 + 2^2 + 2^3 = 2^4 -1 = 2^(n-1) - 1 = 0.5 * 2^n - 1
